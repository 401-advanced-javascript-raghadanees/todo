...
.slice((props.page - 1) * settingsContext.tasksPerPage, (props.page) * settingsContext.tasksPerPage)
  ...
  return (
    <>
   <Button class="d-inline" style={{ width: '5.5rem',fontSize: '0.7rem', margin: 0.5 + 'rem', float: 'right' }} variant='dark' onClick={() => (settingsContext.showComplete ? settingsContext.setShowComplete(false) : settingsContext.setShowComplete(true))} > Other tasks {console.log('settingsContext.setShowComplete',!(settingsContext.showComplete))} </Button>
